  ...
  return (
      <section id='about'>
        ...
        <div data-aos='fade-left' className='row'>
          {length === 'short' ? (
              <p className='short-p'>Hello, I'm Hanna!<br></br><br></br> I'm a <em style={{ color: '#ef476f' }}>Frontend Web Developer</em> currently looking for an internship or entry-level job to continue my professional career.
